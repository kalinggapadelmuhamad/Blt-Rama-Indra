...
if (isset($_GET['kode'])) {
	$sql_cek = "SELECT * FROM tb_umk WHERE id_umkm='" . $_GET['kode'] . "'";
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" id="id_umkm" name="id_umkm" value="<?php echo $data_cek['id_umkm']; ?>" readonly />
				</div>
			</div>
