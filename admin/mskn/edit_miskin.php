...
if (isset($_GET['kode'])) {
	$sql_cek = "SELECT * FROM tb_mkn WHERE id_mskn='" . $_GET['kode'] . "'";
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" id="id_mskn" name="id_mskn" value="<?php echo $data_cek['id_mskn']; ?>" readonly />
				</div>
			</div>
		...
		<div class="card-footer">
			...
			<a href="?page=data-miskin" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
if (isset($_POST['Ubah'])) {
	...
	if ($query_ubah) {
      ...
      Swal.fire({title: 'Ubah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
        ...
        {window.location = 'dashboard.php?page=data-miskin';
        }
      })</script>";
	} else {
		echo "<script>
