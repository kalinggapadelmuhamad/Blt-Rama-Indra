	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="dashboard.php" class="nav-link">
						<font color="white">
							<b>SISTEM INFORMASI BANTUAN LANGSUNG TUNAI</b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="dashboard.php" class="brand-link">
				...
				<span class="brand-text"> BLT</span>
			</a>
						...
						?>
							...
							<li class="nav-item has-treeview">
								...
								<ul class="nav nav-treeview">
									...
									<li class="nav-item">
										<a href="?page=data-miskin" class="nav-link">
											<i class="nav-icon far fa-circle text-warning"></i>
											<p>BLT Masyarakat Miskin</p>
										</a>
									</li>
									<li class="nav-item">
										<a href="?page=data-umkm" class="nav-link">
											<i class="nav-icon far fa-circle text-warning"></i>
											<p>BLT UMKM</p>
										</a>
									</li>
					...
					if (isset($_GET['page'])) {
						...
						switch ($hal) {
							...
							case 'view-pend':
								...
								break;
							case 'add-imp':
								include "admin/pend/add_imp.php";
								break;
								...
								//umkm
							case 'data-umkm':
								include "admin/umkm/data_umkm.php";
								break;
							case 'add-umkm':
								include "admin/umkm/add_umkm.php";
								break;
							case 'edit-umkm':
								include "admin/umkm/edit_umkm.php";
								break;
							case 'del-umkm':
								include "admin/umkm/del_umkm.php";
								break;
							case 'view-umkm':
								include "admin/umkm/view_umkm.php";
								break;
							case 'add-impk':
								include "admin/umkm/add_impk.php";
								break;
								...
								//miskin
							case 'data-miskin':
								include "admin/mskn/data_miskin.php";
								break;
							case 'add-miskin':
								include "admin/mskn/add_miskin.php";
								break;
							case 'edit-miskin':
								include "admin/mskn/edit_miskin.php";
								break;
							case 'del-miskin':
								include "admin/mskn/del_miskin.php";
								break;
							case 'view-miskin':
								include "admin/mskn/view_miskin.php";
								break;
							case 'add-imps':
								include "admin/mskn/add_imps.php";
								break;
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				...
				<a target="_blank" href="https://www.youtube.com/channel/UCDxjOzW7F0JOkltlXT6g7AQ">
					<strong> Desa Rama Indra</strong>
				</a>
				All rights reserved.
			</div>
			<b>Website Bantuan Langsung Tunai</b>
		</footer>
